              ...
              @foreach ($categories as $category)
                  ...
                  <td>{{ $category->id }}</td>
                    <td>{{ $category->name }}</td>
                      ...
                      <td>
                      {{ $category->created_at?$category->created_at->diffForHumans():'no time' }}
                      </td>
                      <td>
                      {{ $category->updated_at?$category->updated_at->diffForHumans():'no time' }}
                      </td>
                    <td>
                    {{-- edit button --}}
                ...
                {{-- delete button --}}
                  <span href="" data-toggle="modal" data-target="#deletecategory{{ $category->id }}" class="close-icon btn btn-danger" title=""><i class="fa fa-trash-o"></i>
                  </span>
